...
# Define a função para obter os dados de entrada do usuário
def user_input_data():
...
# Imagem do repositório do GitHub
image_url = "https://raw.githubusercontent.com/seu_usuario/seu_repositorio/caminho_para_imagem/imagem.jpg"
st.image(image_url, caption='Imagem do Repositório do GitHub', use_column_width=True)
